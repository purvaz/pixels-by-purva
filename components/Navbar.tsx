...
//   const [isOpen, setIsOpen] = useState(true); // for mobile tabs
...
//       // Show subtitle only at top
//       setShowSubtitle(currentScrollY < 10);

//       // Show/hide navbar on scroll direction
//       const delta = currentScrollY - lastScrollY.current;

//       if (Math.abs(delta) < 20) return; //ignore insignificant scrolls
...
//         } fixed top-0 left-0 w-full z-50 bg-white px-4 md:px-8 lg:px-12 pt-10 pb-4 font-serif`}
//     >
